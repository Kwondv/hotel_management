...
public class Hotel_Main extends JFrame {
	...
	public Hotel_Main(hotelDTO dto) {
		...
		main_chat_Button.setFont(new Font("³ª´®½ºÄù¾î Bold", Font.PLAIN, 20));
		...
		main_check_Button.setFont(new Font("³ª´®½ºÄù¾î Bold", Font.PLAIN, 20));
		main_check_Button.setBounds(12, 382, 497, 240);
		contentPane.add(main_check_Button);
		
		JLabel main_label = new JLabel("\uBA54\uC778 \uD654\uBA74");
		main_label.setFont(new Font("³ª´®½ºÄù¾î Bold", Font.PLAIN, 50));
		...
		main_logout_Button.setFont(new Font("³ª´®½ºÄù¾î Bold", Font.PLAIN, 20));
