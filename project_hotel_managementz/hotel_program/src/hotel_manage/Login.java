...
public class Login extends JFrame {
	...
	public Login() {
		...
		id_textField.setFont(new Font("³ª´®½ºÄù¾î Bold", Font.PLAIN, 25));
		...
		passwd_passwordField.setFont(new Font("³ª´®½ºÄù¾î Bold", Font.PLAIN, 25));
		...
		room_textField.setFont(new Font("³ª´®½ºÄù¾î Bold", Font.PLAIN, 25));
		...
		login_button.setFont(new Font("³ª´®½ºÄù¾î Bold", Font.PLAIN, 50));
		login_button.setBounds(822, 317, 200, 356);
		contentPane.add(login_button);
		
		JLabel login_id_label = new JLabel("\uC544\uC774\uB514");
		login_id_label.setFont(new Font("³ª´®½ºÄù¾î Bold", Font.PLAIN, 30));
		...
		login_passwd_label.setFont(new Font("³ª´®½ºÄù¾î Bold", Font.PLAIN, 30));
		...
		login_Room_label.setFont(new Font("³ª´®½ºÄù¾î Bold", Font.PLAIN, 30));
		...
		login_main_label.setFont(new Font("³ª´®½ºÄù¾î Bold", Font.PLAIN, 90));
